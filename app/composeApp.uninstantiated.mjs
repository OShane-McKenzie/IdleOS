...
export async function instantiate(imports={}, runInitializer=true) {
    ...
    const js_code = {
        ...
        'jsFeatures.downLink_$external_prop_getter' : (_this) => _this.downLink,
        'jsFeatures.effectiveType_$external_prop_getter' : (_this) => _this.effectiveType,
        'jsFeatures.rtt_$external_prop_getter' : (_this) => _this.rtt,
        'jsFeatures.saveData_$external_prop_getter' : (_this) => _this.saveData,
        'jsFeatures.addEventListener_$external_fun' : (_this, p0, p1) => _this.addEventListener(p0, p1),
        'jsFeatures.removeEventListener_$external_fun' : (_this, p0, p1) => _this.removeEventListener(p0, p1),
        'jsFeatures.deviceMemory_$external_prop_getter' : (_this) => _this.deviceMemory,
        'jsFeatures.hardwareConcurrency_$external_prop_getter' : (_this) => _this.hardwareConcurrency,
        'jsFeatures.connection_$external_prop_getter' : (_this) => _this.connection,
        'jsFeatures.navigator_$external_prop_getter' : () => navigator
    }
